        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-12 my-auto mx-auto">
                    ...
                    <!-- Payment Form -->
                    <form:form action="${pageContext.request.contextPath}/pay/charge" method="post" id="payment-form" modelAttribute="stripeUtils">
...
//                            URL to send the POST request
                                $.post(
                                        "${pageContext.request.contextPath}/payment",
